...
> **Last Updated:** February 19, 2026 | Session 115 Complete
>
...
> **🚨 Read [GUARDRAILS](1.1-GUARDRAILS_v2.md) before starting work.**
...
| Data Quality | Duplicate League Fix | ✅ Complete | 59 |
| Universal Data Quality | Pipeline Integration | ✅ Complete | 60 |
| Data Integrity | Alphanumeric Team ID Fix | ✅ Complete | 61 |
| Canonical Registries | Self-Learning System | ✅ Complete | 62 |
| Universal Discovery | Adaptive Learning Infra | ✅ Complete | 63 |
| Adaptive Learning | Pipeline Integration | ✅ Complete | 64 |
| UI/UX | Ranking Journey Chart Fix | ✅ Complete | 65 |
| UI/UX | V1→V2 UI Migration Fix | ✅ Complete | 66 |
| UI/UX | Team Details UI Refinements | ✅ Complete | 67 |
| UI/UX | Rating Journey Chart Redesign | ✅ Complete | 68 |
| Infrastructure | Index Maintenance + Backlog Clear | ✅ Complete | 69 |
| Ranking Algorithm | Consistent Baseline Methodology | ✅ Complete | 70 |
| UI/UX | Compare Chart Fix | ✅ Complete | 71 |
| Data Integrity | NULL Score Fix | ✅ Complete | 72 |
| UI/UX | VS Battle Page Fixes | ✅ Complete | 73 |
| Data Integrity | HTGSports Division Detection Fix | ✅ Complete | 74 |
| Data Integrity | Real-Time Data Consistency Fix | ✅ Complete | 75 |
| Data Integrity | GotSport Rankings Bypass Fix | ✅ Complete | 76 |
| Data Integrity | NULL Metadata & Orphan Merge | ✅ Complete | 77 |
| Data Integrity | Orphan Root Cause Analysis | ✅ Complete | 78 |
| V2 Architecture | Pipeline Enforcement & Docs | ✅ Complete | 79 |
| V2 Architecture | Git Hygiene & Heartland Gap ID | ✅ Complete | 80 |
| Infrastructure | Pipeline Reliability & Unified Adapter | ✅ Complete | 81 |
| V2 Migration | V1 Archive Migration to V2 | ✅ Complete | 82 |
| Data Quality | Complete V1 Extraction & Foundation First | ✅ Complete | 83 |
| Data Policy | Premier-Only Data Policy | ✅ Complete | 84 |
| Data Architecture | Universal SoccerView ID Architecture | ✅ Complete | 85 |
| Data Recovery | Match Recovery & Soft Delete Pattern | ✅ Complete | 86 |
| Data Quality | Universal Canonical Resolver & Gender Fix | ✅ Complete | 87 |
| Data Pipeline | HTGSports Scraping + Pipeline Fixes | ✅ Complete | 87.2 |
| Data Quality | Universal QC Fix (4 Issues) | ✅ Complete | 88 |
| Entity Resolution | Universal Source Entity Map + Team Merge | ✅ Complete | 89 |
| Entity Resolution | Cross-import duplicate fix | ✅ Complete | 90 |
| Data Quality | Generic Event Name Prevention + Display Utils | ✅ Complete | 91 |
| League Standings | Filter Polish + Division Data Backfill | ✅ Complete | 91b |
| League Standings | Passthrough Architecture + Hybrid View | ✅ Complete | 92 |
| Data Quality | Dual-System Lightweight Standings Resolver | ✅ Complete | 92 QC |
| Infrastructure | Fix Broken Views + Architecture Verification | ✅ Complete | 92 QC2 |
| Data Quality | Double-Prefix Fix + Duplicate Team Merge | ✅ Complete | 93 |
| Data Quality | LEAST/GREATEST Rank Preservation (8 files) | ✅ Complete | 94 P1 |
| Data Quality | GotSport Rankings Matching + Pipeline Phase 2.7 | ✅ Complete | 94 P2 |
| National Expansion | SINC Sports + NC + Division-Seeded ELO | ✅ Complete | 95 |
| National Expansion | NC Post-Expansion QC | ✅ Complete | 96 |
| National Expansion | MLS Next + SportsAffinity GA | ✅ Complete | 97 |
| National Expansion | ECNL + FL/TX + MLS Next Fix | ✅ Complete | 98 |
| National Expansion | App Bug Fixes + Master Plan | ✅ Complete | 98b |
| National Expansion | Wave 3 SportsAffinity (5 states) | ✅ Complete | 99 |
| National Expansion | ECNL Full Scrape (76 events) | ✅ Complete | 100 |
| National Expansion | ECNL Future-Proofing + Wave 2d | ✅ Complete | 101 |
| National Expansion | PlayMetrics Adapter (CO + SDL) | ✅ Complete | 102 |
| National Expansion | Demosphere Adapter (VA/DC) + WI | ✅ Complete | 103 |
| National Expansion | Squadi Adapter (AR) + IL/VA/WI Gap Fill | ✅ Complete | 104 |
| National Expansion | HI SportsAffinity + RI Skeleton | ✅ Complete | 105 |
| National Expansion | Girls Academy + USYS NL + NPL TCSL TX | ✅ Complete | 106 |
| Data Quality | Universal Team Key Normalization Fix | ✅ Complete | 107 |
| Infrastructure | Pipeline Freshness & Reliability (3 systemic fixes) | ✅ Complete | 108 |
| League Standings | GotSport Standings Scraper (40 leagues) | ✅ Complete | 109 |
| League Standings | Standings Mega-Sprint (Demosphere+Squadi+PlayMetrics) | ✅ Complete | 110 |
| League Standings | TGS Standings + CO CAL Spring + Spring Blitz | ✅ Complete | 111 |
| National Expansion | "Between Seasons" Banned + NO LEAGUE States | ✅ Complete | 112 |
| National Expansion | AthleteOne Adapter + 50-State Audit | ✅ Complete | 113 |
| **FINAL Sprint** | **All Open Items: 30 checkboxes, 7 blocks, TN→Squadi** | ✅ Complete | **FINAL** |
| Data Quality | TN Squadi + NM DCSL + Universal Event Metadata Fixes | ✅ Complete | 115 |

---

## Session 115 - TN Squadi + NM DCSL + Universal Event Metadata Fixes (February 19, 2026) - COMPLETE

**Focus:** (1) Build TN Squadi adapter from Session FINAL discovery. (2) Add NM DCSL via TGS. (3) Comprehensive audit of pipeline metadata gaps. (4) Fix all event creation paths (forward-prevention + retroactive backfill).

### Key Results
- **TN State Soccer League added to squadi.js** — 5 events, 5,509 matches staged
- **NM DCSL event 3410** added to totalglobalsports.js — 120 matches
- **Universal event metadata fix** — fastProcessStaging.cjs + dataQualityEngine.js now include state, season_id, SEM registration on event creation
- **DQE tournament CURRENT_DATE bug fixed** — now uses match-derived date range
- **Retroactive backfills:** 121 league states, 48 season_ids, 1,690 tournament states, 79 SEM entries
- **12,342 league_standings source_platform corruption fixed** — bare GotSport event IDs → 'gotsport'
- **4,312 TN standings processed** (0 unprocessed remaining)
- **ELO recalculated:** 237,657 matches, 75,811 teams
- **All 5 materialized views refreshed**

### Verification Results

| Metric | Before Session 115 | After | Target | Status |
|--------|-------------------|-------|--------|--------|
| League state | 68.2% (150 NULL) | 93.9% (29 NULL) | >90% | PASS |
| League season_id | 89.4% (50 NULL) | 99.6% (2 NULL) | >95% | PASS |
| Tournament state | 1.5% (1,773 NULL) | 95.4% (83 NULL) | >90% | PASS |
| Standings | 30,073 | 33,943 | >30K | PASS |
| Unprocessed standings | 4,312 | 0 | 0 | PASS |
| Forward-prevention | 0/7 checks | 7/7 checks | All green | PASS |

### New Principle
- **Principle 48:** Event creation MUST include state (from staging_events), season_id (from match dates), and SEM registration. Applies to fastProcessStaging.cjs AND dataQualityEngine.js.

### Files Modified
- `scripts/maintenance/fastProcessStaging.cjs` — event state + season_id + SEM registration
- `scripts/universal/dataQualityEngine.js` — same fixes + tournament CURRENT_DATE bug
- `scripts/universal/coreScraper.js` — event_state propagation to raw_data
- `scripts/adapters/squadi.js` — TN State Soccer League (5 events)
- `scripts/adapters/totalglobalsports.js` — NM DCSL event 3410

---

## Session FINAL - All Open Items Sprint (February 18, 2026) - COMPLETE

**Focus:** Execute all 30 checkboxes across 7 blocks (A-G) in one sprint. Complete all remaining items from Sessions 112-116 plan.

### Key Results
- **30,074 league standings** (from 19,749 — processed 342-league GotSport standings batch)
- **180 double-prefix teams fixed** (Rush Rush, SC SC, FC FC, Celtic Celtic, United United)
- **ELO recalculated:** 236,126 matches, 74,901 teams
- **Pipeline timeouts fixed:** GotSport Events + Scrape Standings 60→120 min
- **TN State Soccer League: Discovered migration from SINC Sports to Squadi** — API keys found
- **WV event 49470 confirmed** (27 divisions, March 14-15 season)
- **MA NECSL Fall 2025 (event 45672) + WV + STXCL WC events** added to staticEvents
- All 5 materialized views refreshed, 7/7 verification checks passed

### Final Metrics
- 529,446 active matches, 197,533 teams, 30,074 standings, 468 leagues
- 105,473 SEM entries, 25 GotSport staticEvents, 12 adapters
- 39,069 upcoming matches linked (96.1%)

### Files Modified
See CLAUDE.md Session FINAL entry for full details.

---

## Sessions 95-113 - National Expansion (February 14-18, 2026) - COMPLETE

**Focus:** 19 sessions expanding from 1 state (KS) at PRODUCTION to 12 adapters covering all 50 states + DC.

See CLAUDE.md for detailed session-by-session history (Sessions 95-113). Key milestones:
- **Session 95:** SINC Sports adapter, NC PRODUCTION, division-seeded ELO
- **Session 97:** MLS Next + SportsAffinity adapters
- **Session 100:** ECNL full scrape (76 events, 33,567 matches)
- **Session 102-104:** PlayMetrics, Demosphere, Squadi adapters
- **Session 108:** Pipeline systemic fix (year filter, smart discovery, cascade protection)
- **Session 109-111:** 7 standings adapters (GotSport, TGS, SINC, Heartland, Demosphere, Squadi, PlayMetrics)
- **Session 113:** AthleteOne adapter (12th), 50-state PRODUCTION audit

---

## Session 94 Part 2 - GotSport Rankings Matching + Pipeline Integration (February 9, 2026) - COMPLETE

**Focus:** Improve restoreGotSportRanks.cjs matching rate (49% → 64%) and integrate as Phase 2.7 in nightly pipeline for automated daily GotSport rankings refresh.

### Problem
49% match rate left gaps in GotSport rankings display (e.g., KS U11 Boys missing state ranks #4 and #11). Three root causes: (1) No `removeDuplicatePrefix()` applied to GS team names, (2) No team_name-only matching tier for non-repeating club prefixes, (3) No source_entity_map entries for GotSport teams.

### Solution
- Added `removeDuplicatePrefix()` normalization (shared with rest of pipeline via `cleanTeamName.cjs`)
- Added Tier 2b/2c: team_name-only matching for non-repeating club prefixes (e.g., "Captains Soccer Club" + "Captains SC Boys 15/16 Blue")
...
- Added Phase 2.7 `refresh-gotsport-rankings` job to `daily-data-sync.yml`
...
- Phase 2.7: Runs after validation, parallel with integrity checks, before ELO
- LEAST/GREATEST safe — never overwrites a better rank
- `continue-on-error: true` — non-blocking for rest of pipeline

### Files Modified
- `scripts/maintenance/restoreGotSportRanks.cjs` — Matching logic overhaul + cache + source_entity_map backfill
- `.github/workflows/daily-data-sync.yml` — Phase 2.7 job + dependencies + summary report

---

## Session 94 Part 1 - LEAST/GREATEST Rank Preservation (February 9, 2026) - COMPLETE

**Focus:** Fix rank preservation across all 8 files that merge or update rank values. Replace COALESCE with LEAST (ranks) or GREATEST (points). Establishes Principle 39.

### Problem
`COALESCE(existing_rank, new_rank)` picks first non-NULL value regardless of magnitude. For ranks where lower = better, this randomly overwrites a better rank (#4) with a worse one (#11). Session 93's 12,716 team merge exposed this — KS U11 Boys had gaps at state ranks #4, #11, #13.

### Solution
Universal rule: `LEAST` for ranks (lower = better), `GREATEST` for points/ELO (higher = better). Applied to 8 files:
...
### Files Modified
All 8 files above. Zero UI changes. Zero data loss.

---

## Session 93 - Double-Prefix Fix + Duplicate Team Merge + Rankings Sort (February 7, 2026) - COMPLETE

**Focus:** Fix three QC issues: (1) Rankings sort order jumbled when state filter applied, (2) Double-prefix team names ("Kansas Rush Kansas Rush Pre-ECNL 14B"), (3) Duplicate team records causing duplicates in rankings.

### Issue 1 — Rankings Sort Order (UI fix)
Rankings displayed state_rank but sorted by national_rank when state filter was active. Fixed in `rankings.tsx` with `.order('national_rank')`.

### Issue 2 — Double-Prefix Team Names (3-layer universal fix)
GotSport API returns `club_name="Kansas Rush"` + `team_name="Kansas Rush Pre-ECNL 14B"`. Concatenation produces "Kansas Rush Kansas Rush Pre-ECNL 14B". Fixed via shared `removeDuplicatePrefix()` in `cleanTeamName.cjs` using N-word sliding window algorithm. Applied to all 3 team creation paths: `teamNormalizer.js`, `fastProcessStaging.cjs`, `processStandings.cjs`. Establishes Principle 38.

### Issue 3 — Duplicate Team Records (primary data layer merge)
12,716 duplicate teams merged via `mergeDuplicateRankedTeams.cjs`. Collision-safe: projects post-merge semantic keys, soft-deletes non-winners before re-pointing.

### Results

| Metric | Before | After |
|--------|--------|-------|
| teams_v2 | 158,072 | **145,356** (-12,716) |
| matches_v2 (active) | 403,068 | **402,948** |
| Double-prefix teams | 18,513 | **0** |
| Duplicate display_name groups | 11,689 | **0** |

### Files Created
`cleanTeamName.cjs`, `fixDoublePrefix.cjs`, `mergeDuplicateRankedTeams.cjs`

### Files Modified
`teamNormalizer.js`, `fastProcessStaging.cjs`, `processStandings.cjs`, `rankings.tsx`

---

## Session 92 QC Part 2 - Fix Broken Views + Architecture Verification (February 7, 2026) - COMPLETE

**Focus:** Fix critical app errors (Home: "0 Matches", Teams: timeout) caused by broken `refresh_app_views()` function. Prove entire architecture is sound with 50-point health check.

### Root Cause
Migration 094 (hybrid UNION ALL standings view) had NO UNIQUE INDEX on `app_league_standings`. The `refresh_app_views()` SQL function used `REFRESH MATERIALIZED VIEW CONCURRENTLY` which requires a unique index. Statement failed → PL/pgSQL rolled back → ALL 5 views stale.

### Solution
Migration 095: Non-concurrent refresh for `app_league_standings` only. All other views retain CONCURRENTLY. RLS enabled on `staging_standings` + `league_standings`.

### Architecture Health Report: **50/50 ALL GREEN**

| Category | Checks | Status |
|----------|--------|--------|
| Layer 1: Intake | 8 | All GREEN |
| Layer 2: Processing | 15 | All GREEN |
| Layer 3: Presentation | 8 | All GREEN |
| Security | 3 | All GREEN |
| Dual-System | 3 | All GREEN |
| Nightly Pipeline | 7 | All GREEN |
| Scale Readiness | 6 | All GREEN |

### Files Created
`095_fix_refresh_views_and_rls.sql`, `diagnose_view_health.cjs`, `verify_architecture_health.cjs`

---

## Session 92 QC - Dual-System Architecture: Lightweight Standings Resolver (February 6, 2026) - COMPLETE

**Focus:** Fix standings page showing only 7 of 11 teams for U-11 Boys Division 1. 439 of 1,173 teams (37%) had NULL metadata, making them invisible in filtered views.

### Root Cause
`processStandings.cjs` used the same heavy 3-tier entity resolution as the match pipeline, including pg_trgm fuzzy matching. Standings data is authoritative — it doesn't need fuzzy matching.

### Solution: Dual-System Architecture (Principle 36)

| | System 1: Match Pipeline | System 2: Standings Absorption |
|-|--------------------------|-------------------------------|
| **Resolver** | Heavy 3-tier (fuzzy) | Lightweight (exact + create) |
| **Shared** | teams_v2 (standings enriches NULL fields, never overwrites) |
...
### Files Modified
`processStandings.cjs` (major rewrite), `1.2-ARCHITECTURE.md`, `3-DATA_SCRAPING_PLAYBOOK.md`, `3-DATA_EXPANSION_ROADMAP.md`

---

## Session 92 - League Standings Passthrough Architecture (February 6, 2026) - COMPLETE

**Focus:** Replace over-engineered standings computation with a hybrid passthrough architecture. Scrape authoritative league standings, store as-is, display as-is. Computed fallback for leagues without scraped data.
...
- `processStandings.cjs`: Lightweight resolver — separate from match pipeline
- `staging_standings` → `league_standings` → `app_league_standings`: Three-layer pattern
- Adding a new standings source = adapter config only

### Pipeline Addition
- Phase 1.5: `scrape-standings` (parallel with match scraping)
- Phase 2.6: `process-standings` (after validation)

### Files Created
`094_league_standings_passthrough.sql`, `scrapeStandings.js`, `processStandings.cjs`

### Files Modified
`heartland.js` (adapter), `daily-data-sync.yml`, `1.2-ARCHITECTURE.md`

---

## Session 91b - League Standings Phase 9: Filter Polish + Division Data Backfill (February 5, 2026) - COMPLETE

**Focus:** Fix 3 QC issues on League Standings page: filter chip visual lag, label truncation, teams showing 0 points due to division data gap.

### Issues Fixed

| # | Issue | Fix |
|---|-------|-----|
| 1 | Filter chips stay grayed out | Gender: `View` replaces `ScrollView`. Age/Div: `nestedScrollEnabled={true}` |
| 2 | "Gender" label truncated | Width 52→62, `numberOfLines={1}` |
| 3 | Teams show 0 points | 3-layer fix: backfill (790) + inference (2,352) + view refresh |
...
### Key Insight
League standings should be passthrough — don't reconstruct what the authority already publishes. This insight drove Session 92's architecture.

### Files Created
`inferMatchDivision.cjs`

### Files Modified
`app/league/[eventId].tsx` (UI fixes only)

---

## Session 91 - Generic Event Name Prevention + Display Utility Integration (February 5, 2026) - COMPLETE

**Focus:** Eliminate generic tournament/league names from production data. Consolidate duplicate display utility functions into shared modules. Build 5-layer defense architecture for event name quality. Zero UI design changes.

### Problem Statement

215 tournaments had generic names ("GotSport Event 12093", "Event 39064") because no pipeline layer rejected them. The eventNormalizer accepted any non-empty string. Additionally, `app/match/[id].tsx` had 3 local patch functions duplicating logic available in shared modules.
...
| 3 | DQE `findOrCreateEvent()` | `null` canonical_name → skip event creation |
| 4 | Fast processors | Own `isGeneric()` / `resolveEventName()` guards |
| 5 | DB CHECK constraint | Blocks generic INSERTs (migration 091) |

**Key Architecture Insight:** `eventNormalizer.js` is the correct validation point. DQE `findOrCreateEvent()` already handles `canonical_name: null` at line 787 → match created unlinked. Fixing the normalizer protects ALL code paths with zero DQE changes.

### Completed Steps

| Step | Description | Result |
|------|-------------|--------|
| 1A | Retroactive data fix | 215 generic tournament names resolved via 4-tier resolver |
| 1B | DB CHECK constraints | Migration 091 blocks future generic INSERTs |
| 1C | Pipeline guards | `resolveEventName.cjs` in fastProcessStaging, linkByEventPattern, linkFromV1Archive, coreScraper |
| 2A | Shared display utils | `lib/matchUtils.ts` — `getMatchStatus()` + `getEventTypeBadge()` |
| 2B | match/[id].tsx cleanup | 3 local patch functions → shared imports |
| 2C | team/[id].tsx cleanup | Inline gender → `getGenderDisplay()` |
| 3 | eventNormalizer guard | `isGeneric()` rejection at normalizer layer |
| 4 | linkUnlinkedMatches guard | `isGeneric()` guard before event creation |
| 5 | Archive dead code | `fastProcessHTG.cjs` → `scripts/_archive/` |

### Files Created
- `scripts/universal/resolveEventName.cjs` — Centralized event name resolver (NULL instead of generic)
- `scripts/maintenance/fixGenericEventNames.cjs` — Retroactive 4-tier generic name fix
- `scripts/migrations/091_block_generic_event_names.sql` — CHECK constraints
- `lib/matchUtils.ts` — Shared match display utilities

### Files Modified
- `scripts/universal/normalizers/eventNormalizer.js` — Added `isGeneric()` rejection
- `scripts/maintenance/linkUnlinkedMatches.js` — Added `isGeneric()` guard
- `scripts/maintenance/fastProcessStaging.cjs` — Integrated `resolveEventName()`
- `scripts/maintenance/linkByEventPattern.js` — Added `isGeneric()` guard
- `scripts/maintenance/linkFromV1Archive.js` — Added `isGeneric()` guard
- `scripts/universal/coreScraper.js` — Added `isGeneric()` + non-generic fallback
- `app/match/[id].tsx` — Replaced 3 local functions with shared imports
- `app/team/[id].tsx` — Replaced inline gender with `getGenderDisplay()`

### Files Archived
- `scripts/maintenance/fastProcessHTG.cjs` → `scripts/_archive/` (superseded by fastProcessStaging)

---

## Session 90 - Fix Cross-Import Duplicate Matches (February 5, 2026) - COMPLETE

**Focus:** Fix duplicate matches in Team Detail tournament sections caused by V1 migration + scraper cross-import.

### Problem Statement

V1 migration (Session 82) and scrapers both imported the same real-world games, but resolved opponent teams to different `teams_v2` records (different name normalization → different IDs). The semantic uniqueness constraint `(match_date, home_team_id, away_team_id)` couldn't catch these because team IDs differ.

### Solution

`scripts/maintenance/fixCrossImportDuplicates.cjs` — CTE-based detection with 6-layer false-positive protection:
...
`fixCrossImportDuplicates.cjs`, `SESSION_90_CROSS_IMPORT_DUPLICATES.md`
...
**Focus:** Eliminate all v1-legacy duplicate teams and build permanent prevention via `source_entity_map` three-tier deterministic resolution.

### Problem Statement

V1 migration created 7,253 duplicate team records with NULL/incomplete metadata (birth_year=null, state='Unknown'). Same real-world team existed as two `teams_v2` records, causing 1,412+ duplicate match pairs visible in Team Details. 100% of duplicates involved v1-legacy data.

### Solution: Three-Tier Entity Resolution

```
Tier 1: source_entity_map lookup (deterministic, O(1), 100% accurate)
Tier 2: Canonical name + NULL-tolerant birth_year fallback
...
| 6-7 | DQE pipeline prevention | Tier 1/2/3 in findOrCreateTeam/Event |
...
| matches_v2 (active) | 407,896 | 405,595 |
| tournaments | 1,728 | 1,711 (-17 merged) |
| source_entity_map | 0 | 3,253 (NEW) |
| V1-legacy duplicate pairs | 7,253 | 0 |
...
`teamDedup.js`, `dataQualityEngine.js`, `fastProcessStaging.cjs`, `coreScraper.js`, `089_universal_source_entity_map.sql`, `backfillSourceEntityMap.cjs`, `mergeV1LegacyDuplicates.cjs`, Architecture/Roadmap/Playbook/CLAUDE.md docs

---

## Session 88 - Universal QC Fix (4 Issues) (February 5, 2026) - COMPLETE

**Focus:** Fix 4 QC issues discovered during app review. All fixes are data-layer only with ZERO UI design changes.

### Problem Statement

App review revealed 4 systemic data quality issues:
1. **Birth year mismatch:** 2014 birth year team appearing in U11 (2015) filter — hardcoded `SEASON_YEAR` in pipeline
2. **Rank badge discrepancy:** Rankings badge showed list position instead of actual DB rank — missing SELECT columns
3. **Wrong state assignment:** "Sporting Iowa" appearing in Kansas filter — unreliable state inference from GotSport
4. **Duplicate matches:** Same game appearing twice in Team Details — reverse matches + missing `deleted_at IS NULL`

### Solution

**QC Issue #1: Birth Year Prevention**
- Made `SEASON_YEAR` dynamic in 4 pipeline files: `teamNormalizer.js`, `fastProcessStaging.cjs`, `fixBirthYearFromNames.cjs`, `fixBirthYearFromDisplayName.cjs`
- All now query `seasons` table or use `get_current_season_year()` DB function
- Zero-code season rollover: just update `seasons` table in August

**QC Issue #2: Rank Badge Fix**
- Added `elo_national_rank`, `elo_state_rank` to Supabase SELECT in `rankings.tsx` line 152
- Standardized `??` (nullish coalescing) operator in rank display logic

**QC Issue #3: State Fix**
- Created `fixTeamStates.cjs`: Retroactive correction — extracted US state names from team display_name
- Added `inferStateFromName()` to `teamNormalizer.js` for pipeline prevention
- 526 teams corrected, 14 state-merge conflicts resolved
- Conservative: skips "Kansas City" (ambiguous KS/MO), "Washington" (state vs DC)

**QC Issue #4: Duplicate Matches (Largest Fix)**

Phase 1 — Defensive filtering:
- Added `.is("deleted_at", null)` to 4 Supabase queries in `app/team/[id].tsx`
- Added `AND deleted_at IS NULL` to 2 SQL queries in `recalculate_elo_v2.js`
- Created migration 088: Recreated 3 materialized views with `deleted_at IS NULL` filters

Phase 2 — Retroactive reverse match dedup:
- Created `fixReverseMatches.cjs`: Conservative detection + bulk soft-delete
- 749 score-consistent reverse duplicates soft-deleted (4,907 remaining = legitimate rematches)
...
| Metric | Before | After |
|--------|--------|-------|
| teams_v2 | 161,231 | 160,705 (state merges) |
| matches_v2 (active) | 410,319 | 407,896 |
| Soft-deleted matches | 1,660 | 2,423 (+749 reverse, +14 state merges) |
| Score-consistent reverse dupes | 749 | 0 |
| Semantic duplicate groups | 0 | 0 |
| ELO teams | 60,864 | 60,817 |
| ELO match range | 1157-1781 | 1157-1782 |

### Files Created/Modified

| File | Change |
|------|--------|
| `app/team/[id].tsx` | MODIFIED - 4 `deleted_at IS NULL` filters |
| `app/(tabs)/rankings.tsx` | MODIFIED - Added elo_national_rank, elo_state_rank to SELECT |
| `scripts/daily/recalculate_elo_v2.js` | MODIFIED - 2 `deleted_at IS NULL` filters |
| `scripts/maintenance/fastProcessStaging.cjs` | MODIFIED - Reverse dedup + state inference |
| `scripts/universal/dataQualityEngine.js` | MODIFIED - Reverse match check + dynamic season |
| `scripts/universal/deduplication/matchDedup.js` | MODIFIED - Reverse match detection |
| `scripts/universal/normalizers/teamNormalizer.js` | MODIFIED - `inferStateFromName()` + dynamic SEASON_YEAR |
| `scripts/maintenance/fixReverseMatches.cjs` | NEW - Retroactive reverse match cleanup |
| `scripts/maintenance/fixTeamStates.cjs` | NEW - Retroactive state correction |
| `scripts/migrations/088_add_deleted_at_filters.sql` | NEW - View recreation with deleted_at filters |
| `docs/SESSION_88_UNIVERSAL_QC_FIX.md` | NEW - QC Issues #1-2 documentation |
| `docs/SESSION_88_QC3_STATE_FIX.md` | NEW - QC Issue #3 documentation |
| `docs/SESSION_88_QC4_DUPLICATE_MATCHES.md` | NEW - QC Issue #4 documentation |

### Key Principles Added

- **Principle 31:** Reverse Match Detection — Same game, swapped home/away teams
- **Principle 32:** State Inference from Team Names — Extract US state from display_name
- **Principle 33:** `deleted_at IS NULL` mandatory in ALL match queries
...
- `subdiv_results.cgi`: DEAD (301 → www → 404)
...
```javascript
// ❌ WRONG - Fuzzy match on name alone
findSimilar(teamName)  // Could match "FC Dallas 2014 Boys" with "FC Dallas 2014 Girls"

// ✅ CORRECT - Exact match on gender+birth_year, THEN fuzzy on name
...
| **Layer 2** | teamNormalizer.js | `/\bU[-\s]?(\d+)\b/i` | ✅ Correct |
| **Layer 2** | clubNormalizer.js | `/^U-?\d+$/i` | ✅ Correct |
| **Layer 2** | dataQualityEngine.js | Uses `birth_year` for matching | ✅ Correct |
| **Layer 3** | SQL views | Dynamic: `'U' \|\| (season_year - birth_year)` | ✅ Dynamic |
| **Layer 3** | App filter UI | Hardcoded U8-U19 list (appropriate) | ✅ Correct |
...
| View | Library | Status |
|------|---------|--------|
| SoccerView individual | gifted-charts | ✅ Unchanged |
| GotSport individual | gifted-charts | ✅ Unchanged |
| Compare overlay | **chart-kit** | ✅ New |
...
const padding = Math.ceil(range * 0.1);  // 10% of 3500 = 350 → shows #1

// NEW: Percentage of actual VALUES
const topPadding = Math.ceil(minRank * 0.1);  // 10% of 304 = 30 → shows #274
...
| View indexes | 12/21 | **21/21** | ✅ Fixed |
...
|--------------------|--------------|-----------------|
| `team_elo` | Session 50 | ✅ Yes - Line 541 |
| `match_results` | Session 50 | ✅ Yes - Lines 551, 558 |
| `rank_history` | Session 50 | ✅ Yes - Line 579 |

### Solution

**V1→V2 Database Query Migration:**
...
| File | Changes |
|------|---------|
| `app/team/[id].tsx` | V1→V2 query migration, event grouping UI |
...
|--------|---------|----------|
| Total rank_history_v2 | 416,904 | — |
| With ELO rating | 416,904 | Aug 2025 → Jan 2026 |
...
| Component | Change |
|-----------|--------|
| `adaptiveLearning.js` | Fixed `supabase.raw()` → proper update patterns |
...
```
Data In → Normalize (uses patterns) → Resolve → Create/Match → Learn → Prevent Future
     ↑                                                                        │
     └──────────────────── Patterns feed back ────────────────────────────────┘
```
...
|-------|---------|------------|-----|
| Season Stats math discrepancy | 14 ≠ W+L+D | Used stored value | Calculate from actual matches |
...
| Match Date | Opponent | DB | Official | ✅ |
|------------|----------|----|---------|----|
| Aug 23 | Wichita SC Alliance | 3-4 | 3-4 | ✅ |
| Aug 30 | Sporting BV IA 2015 | 2-1 | 2-1 | ✅ |
| Sep 6 | Armour SC Armour | 7-3 | 7-3 | ✅ |
| Sep 14 | Union KC Jr Elite B15 | 4-1 | 4-1 | ✅ |
| Sep 20 | KC Dynamos 15B | 3-0 | 3-0 | ✅ |
| Sep 28 | Breakers FC Pre-Aca... | 3-4 | 3-4 | ✅ |
| Oct 5 | Heat FC B2015 | 5-4 | 5-4 | ✅ |
| Oct 12 | KC Fusion 2015 | 0-2 | 0-2 | ✅ |
...
- ✅ No manual static list maintenance
- ✅ Adaptive learning stores patterns
- ✅ 100% data integrity vs official source
...
4. `teamDedup.js` - Auto-merge at ≥0.95 similarity
...
- "7115" (numeric) ✅ Matched
- "711A" (alphanumeric) ❌ **Skipped entirely**
...
|-------|-------------|--------|
| Phase 0 | Immediate Fixes (Heartland merge, seasons) | ✅ Complete |
| Phase 1 | Canonical Registries (DB functions) | ✅ Complete |
| Phase 2 | Normalizers (team, event, match, club) | ✅ Complete |
| Phase 3 | Core Engine (dataQualityEngine.js) | ✅ Complete |
| Phase 4 | Deduplication (match, team, event dedup) | ✅ Complete |
| Phase 5 | Infrastructure Population (clubs, leagues) | ✅ Complete |
| Phase 6 | Pipeline Integration (GitHub Actions) | ✅ Complete |
