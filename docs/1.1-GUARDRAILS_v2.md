...
### Root Cause (Session 99)

The season was documented as a DATA PROPERTY (ELO uses Aug 1 start date) but not as an OPERATIONAL REQUIREMENT (scrapers must cover both halves). This led to an entire session configuring only Spring 2026 events while Fall 2025 was completely ignored.
